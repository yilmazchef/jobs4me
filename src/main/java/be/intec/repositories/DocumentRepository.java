...
public class DocumentRepository {
    ...
    public int save( DocumentEntity record ) throws DocumentException {
        ...
        try {
            ...
            statement.setString(2, record.getRawData());
    ...
    public DocumentEntity findById( Integer id ) throws DocumentException {
        ...
        try {
            ...
            if(results.next()){
                ...
                item.setRawData( results.getString("raw_data") );
    ...
    public List<DocumentEntity> findAllByExample( DocumentEntity example ) throws DocumentException {
        ...
        try {
            ...
            statement.setString( 2, example.getRawData() );
    ...
    public int updateRawDataById( Integer id, String rawData ) throws DocumentException {
    ...
    public List<DocumentEntity> searchByRawData( String rawData ) throws DocumentException {

        final List<DocumentEntity> itemList = new ArrayList<>();

        try {
            String query = "select id, name, raw_data, url, last_updated from document where raw_data LIKE ?";
            connection = getConnection();
            statement = connection.prepareStatement(query);
            statement.setString( 1, rawData );
    ...
    public boolean existsByRawData( String rawData ) throws DocumentException {
